...
Gen_button_image = functions_constants.make_img(functions_constants.confirm_image,(100,50))
...
root_canvas.create_text(400,250,text="Modern Art Generator",font=("",28),fill="Black")
